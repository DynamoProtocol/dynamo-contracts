...
contract FeeDistributor is DynamoOwnable, SystemStart, DelegatedOps {
    ...
    constructor(address _dynamoCore, ITokenLocker _tokenLocker) DynamoOwnable(_dynamoCore) SystemStart(_dynamoCore) {
