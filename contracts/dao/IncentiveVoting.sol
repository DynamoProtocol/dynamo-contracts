...
/**
    @title Dynamo Incentive Voting
    @notice Users with DYNAMO balances locked in `TokenLocker` may register their
            lock weights in this contract, and use this weight to vote on where
            new DYNAMO emissions will be released in the following week.
...
contract IncentiveVoting is DelegatedOps, SystemStart {
    ...
    constructor(address _dynamoCore, ITokenLocker _tokenLocker, address _vault) SystemStart(_dynamoCore) {
