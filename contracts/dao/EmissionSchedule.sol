...
/**
    @title Dynamo Emission Schedule
    @notice Calculates weekly DYNAMO emissions. The weekly amount is determined
 ...
 */
contract EmissionSchedule is DynamoOwnable, SystemStart {
    ...
    // percentage of the unallocated DYNAMO supply given as emissions in a week
