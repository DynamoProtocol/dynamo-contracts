...
/**
    @title Dynamo Governance Token
    @notice Given as an incentive for users of the protocol. Can be locked in `TokenLocker`
            to receive lock weight, which gives governance power within the Dynamo DAO.
 */
contract DynamoToken is OFT, IERC2612 {
    // --- ERC20 Data ---

    string internal constant _NAME = "Dynamo Governance Token";
    string internal constant _SYMBOL = "DYNAMO";
    ...
    function permit(
        ...
        require(deadline >= block.timestamp, "DYNAMO: expired deadline");
        ...
        require(recoveredAddress == owner, "DYNAMO: invalid signature");
