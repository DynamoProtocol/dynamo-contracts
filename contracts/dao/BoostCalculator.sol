...
/**
    @title Dynamo Boost Calculator
    @notice "Boost" refers to a bonus to claimable DYNAMO tokens that an account
            receives based on it's locked DYNAMO weight. An account with "max boost"
            is earning DYNAMO rewards at a multiplier `maxBoostMultiplier` compared
            ...
            * During epoch 2, a total of 500,000 new DYNAMO rewards are made available.
            * `maxBoostablePct` is set to 200. This means that during epoch 2, Alice
              can claim up to 20% (10% * 200%) of the rewards (100,000 DYNAMO) with the
              maximum boost multiplier.
            * Once Alice's claims exceed 100,000 DYNAMO, she enters the decay phase.
              `decayBoostPct` is set to 50, meaning Alice can claim up to 5% (10% * 50%) of
              the rewards (25,000 DYNAMO) with a decaying boost.
            * Once Alice's claims exceed 125,000 DYNAMO, any further claims that epoch
              receive no boost.
 ...
 */
contract BoostCalculator is DynamoOwnable, SystemStart {
    ...
    /**
        ...
        @param totalEpochEmissions Total DYNAMO emissions released this epoch
    ...
    /**
        ...
        @param totalEpochEmissions Total DYNAMO emissions released this epoch
        @return adjustedAmount Amount of DYNAMO received after applying boost
     */
