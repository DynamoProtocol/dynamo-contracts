...
/**
    @title Dynamo Borrower Operations
    @notice Based on Liquity's `BorrowerOperations`
            ...
            Dynamo's implementation is modified to support multiple collaterals. There is a 1:n
            relationship between `BorrowerOperations` and each `TroveManager` / `SortedTroves` pair.
 */
contract BorrowerOperations is DynamoBase, DynamoOwnable, DelegatedOps {
    ...
    ) DynamoOwnable(_dynamoCore) DynamoBase(_gasCompensation) {
    ...
    function openTrove(
        ...
        vars.ICR = DynamoMath._computeCR(_collateralAmount, vars.compositeDebt, vars.price);
        vars.NICR = DynamoMath._computeNominalCR(_collateralAmount, vars.compositeDebt);
    ...
    function addColl(
        ...
        require(!DYNAMO_CORE.paused(), "Trove adjustments are paused");
    ...
    function withdrawDebt(
        ...
        require(!DYNAMO_CORE.paused(), "Withdrawals are paused");
    ...
    function adjustTrove(
        ...
        require((_collDeposit == 0 && !_isDebtIncrease) || !DYNAMO_CORE.paused(), "Trove adjustments are paused");
    ...
    function _triggerBorrowingFee(
        ...
        debtToken.mint(DYNAMO_CORE.feeReceiver(), debtFee);
    ...
    function _requireValidAdjustmentInCurrentMode(
        ...
        uint256 oldICR = DynamoMath._computeCR(_vars.coll, _vars.debt, _vars.price);
    ...
    function _getNewICRFromTroveChange(
        ...
        uint256 newICR = DynamoMath._computeCR(newColl, newDebt, _price);
        return newICR;
    }
    ...
    function _getNewTCRFromTroveChange(
        ...
        uint256 newTCR = DynamoMath._computeCR(totalColl, totalDebt);
        return newTCR;
    }
    ...
    function _getTCRData(
        ...
        amount = DynamoMath._computeCR(totalPricedCollateral, totalDebt);
