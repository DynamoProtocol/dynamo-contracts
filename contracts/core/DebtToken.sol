...
contract DebtToken is OFT {
    ...
    // --- Addresses ---
    IDynamoCore private immutable _dynamoCore;
    ...
    // --- Functions for intra-Dynamo calls ---
    ...
    function flashLoan(
        ...
        _transfer(address(receiver), _dynamoCore.feeReceiver(), fee);
        return true;
    }
